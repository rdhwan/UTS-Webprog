...
<body class="flex flex-col min-h-screen min-w-full bg-[url('../images/bg.png')] bg-cover font-inter">
    <form class="flex flex-col flex-1" method="post" action="process_add.php">
        <div class="flex justify-center items-center">
            ...
            <div class="flex flex-rows flex-1 justify-between items-center m-8">
                ...
                <label class="btn btn-circle w-12 h-12 swap">
                    ...
                    <i class="ph-fill ph-star text-yellow-600 swap-on text-2xl"></i> </label>
            </div>
            ...
            <div class="flex flex-col rounded-3xl items-center justify-evenly bg-white p-10 md:p-10 gap-4 m-4">
                ...
                <div class="flex flex-col align-center w-[16rem]">
                    ...
                    <label class="bg-transparent rounded-none border-b-2 h-10"
                        ...
                        <input type="text" name="name" required class="grow h-9" placeholder="Type your username" />
                    </label>
                    </br>
                    ...
                    <label class="bg-transparent rounded-none border-b-2 h-10"
                        ...
                        <input type="text" name="companyName" required class="grow h-9"
                    ...
                    <label class="bg-transparent rounded-none border-b-2 h-10"
                        ...
                        <input type="email" name="email" required class="grow h-9" placeholder="Type your email" />
                    </label>
                    </br>
                    ...
                    <label class="bg-transparent rounded-none border-b-2 h-10"
                        ...
                        <input type="tel" name="phoneNumber" required maxlength="12" class="grow h-9"
